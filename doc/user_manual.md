# FlexTimer v12 用户使用手册 📖

欢迎使用 **FlexTimer v12** —— 您的专业会议与演示时间管理助手。本手册将带您快速上手，轻松掌握这款高颜值、强功能的计时工具。
...
会议结束后，点击 **“管理”** -> **“历史记录”** 标签，或直接点击顶部的 **“复盘” (Review)** 按钮。
...
**Q: 窗口挡住了我的 PPT 怎么办？**
A: 您可以在外观设置中降低“窗口透明度”，或者开启“鼠标穿透”模式（如果支持）。v12 版本采用了玻璃拟态设计，本身就具有很好的通透性。
